-- Create revisoes table compatible with existing bigint carro_id
CREATE TABLE IF NOT EXISTS revisoes (
    id BIGSERIAL PRIMARY KEY,
    carro_id BIGINT REFERENCES carros(id) ON DELETE CASCADE,
...
-- Create tanque_status table compatible with existing bigint carro_id
